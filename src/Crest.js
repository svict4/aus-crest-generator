...
const Crest = ({ title = "Australian Government", agency = "" }) => {
  ...
  const viewBoxHeight =
    crestHeight + (title ? (paddingTopBottom / 2) + titleFontSize : 0) + (agency ? (paddingTopBottom) + titleFontSize : 0) + 3; // + padding + line + agency height;
