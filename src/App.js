...
const defaultWidth = 338.08;
const defaultHeight = 248.76;

const textWidth = 500;

function App() {
  const calculateViewBox = `0 0 ${defaultWidth + textWidth} ${defaultHeight + 75}`;
  const transform = `translate(${textWidth/2} 0)`

  const Crest = ({ label, x, y, width, height }) => {
    return (
      <svg
